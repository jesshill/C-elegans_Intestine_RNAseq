...
# save figure
plt.savefig('03_output/intestine/changing_all_genes_Enrichment_Results.svg', bbox_inches='tight')  

# save the results from GO to a csv
results = result["go"]
results.to_csv('03_output/intestine/Results-changing_all_genes-comparison.csv', index=False)
```
```{python}
