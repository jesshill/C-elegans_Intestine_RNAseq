...
```{r}
# Save the plot
png("03_output/intestine/MA plot - CeMbio.yes_CeMbio.no_clecs.png")
# Reset plotting parameters to their default values
par(mfrow=c(1,1))
# plot the data
ggmaplot(reslfc_CeMbio.yes_CeMbio.no_data_sets, 
   ...
   top = 0) + geom_label_repel(data = subset(reslfc_CeMbio.yes_CeMbio.no_data_sets, wikigene_name %in% clec_IDs$Gene_name), #max.overlaps = getOption("ggrepel.max.overlaps", default = 10),
