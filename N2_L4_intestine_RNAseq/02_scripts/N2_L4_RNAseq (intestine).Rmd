...
for analysis, dictionary in frames.items():
  result[analysis] = ea.enrichment_analysis(sign_OP50_yes_OP50_no.wbps_gene_id, dictionary, show=True, alpha=10**-1)
...
# save figure
plt.savefig('03_output/intestine/sign_OP50_yes_OP50_no_Enrichment_Results.svg', bbox_inches='tight')  

# save the results from GO to a csv
results = result["go"]
results.to_csv('03_output/intestine/Results-sign_OP50_yes_OP50_no-comparison.csv', index=False)
```
