...
sign_OP50.yes_OP50.no <- biomaRt::getBM(
  mart = paramart,
...
sign_OP50.yes_OP50.no <- sign_OP50.yes_OP50.no %>% rename(WBgeneID = "wbps_gene_id")

write_csv(sign_OP50.yes_OP50.no, file = "03_output/intestine/sign_OP50.yes_OP50.no_sets.csv")
```
